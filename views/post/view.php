...
$this->subtitle = Yii::t('forum', 'вернуться в раздел') . Html::a($topic->forum->name, Url::to(['topic/view', 'id' => $topic->forum->id]));
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('forum', $topic->forum->name), 'url' => ['topic/view', 'id' => $topic->forum->id]];
...
<div class="topic-view">
    ...
    <?php if (!Yii::$app->getUser()->getIsGuest()): ?>
        <?= EditorWidget::widget([
            'activeFormOptions' => [
                'action' => Url::to(['post/view', 'id' => $topic->id, '#' => 'postform']),
            ],
            'model' => $model,
